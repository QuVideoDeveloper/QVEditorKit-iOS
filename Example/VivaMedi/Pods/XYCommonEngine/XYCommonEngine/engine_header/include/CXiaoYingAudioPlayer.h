...
#define QVET_PROP_AUDIO_PITCH		 (QVET_PROP_AUDIO_PLAYER_BASE + 6)//变速时的的audio pitch
#define QVET_PROP_AUDIO_PITCH_VALUE  (QVET_PROP_AUDIO_PLAYER_BASE + 7)//非变速时的audio pitch
