...
#define AMVE_FACEDT_MODE_ASYNC         0
#define AMVE_FACEDT_MODE_SYNC          1
...
* @return   QVET_ERR_NONE if success,other value if failed
**/
MRESULT FaceDTUtils_ConvertDTPoint(MHandle hContext,MPOINT* pDTPoint,MPOINT* pDstPoint);
 ...
 * @return   QVET_ERR_NONE if success,other value if failed
 **/
MRESULT FaceDTUtils_ConvertDTPointToSrcSize(MHandle hContext,MPOINT* pDTPoint,MPOINT* pDstPoint);
