...
#define MV2_CFG_EXTRACT_AUDIO_FLAG						(MV2_CFG_MEDIAFILE_BASE+217)   //导出m4a文件的flag,数据类型MBool

#define	MV2_CFG_SPLITER_ACODEC_SAMPLE_FMT			    (MV2_CFG_MEDIAFILE_BASE+218)   //导出aac的sample rate,数据类型MDWord
...
#define MV2_CFG_CUSTOM_STREAM_FRAME_SIZE                (MV2_CFG_CUSTOM_BASE + 64)

#define MV2_CFG_CUSTOM_EXPORT_AUDIO_ONLY                (MV2_CFG_CUSTOM_BASE + 65)

#define MV2_CFG_CUSTOM_DISTURB_PREPARE                  (MV2_CFG_CUSTOM_BASE + 66)

#define MV2_CFG_CUSTOM_RENDER_API                       (MV2_CFG_CUSTOM_BASE + 67)

#define MV2_CFG_CUSTOM_LOCK_TEXTURE                     (MV2_CFG_CUSTOM_BASE + 68) 
 
#define MV2_CFG_CUSTOM_UNLOCK_TEXTURE                   (MV2_CFG_CUSTOM_BASE + 69) 

#define MV2_CFG_CUSTOM_EFFECT_STREAM                    (MV2_CFG_CUSTOM_BASE + 70) 

//bound box of animation text
#define MV2_CFG_CUSTOM_TEXT_BOUND                       (MV2_CFG_CUSTOM_BASE + 71)

#define MV2_CFG_CUSTOM_DISTURB_SEEK_CBDATA              (MV2_CFG_CUSTOM_BASE + 72)

#define MV2_CFG_CUSTOM_CUR_STORYBOARD_INFO              (MV2_CFG_CUSTOM_BASE + 73)

#define MV2_CFG_CUSTOM_CUR_CLIP_INFO                    (MV2_CFG_CUSTOM_BASE + 74)

#define MV2_CFG_CUSTOM_CUR_TRANSITION_CLIP_INFO         (MV2_CFG_CUSTOM_BASE + 75)

#define MV2_CFG_CUSTOM_CUR_EFFECT_INFO_LIST             (MV2_CFG_CUSTOM_BASE + 76)

#define MV2_CFG_CUSTOM_EXPORT_VIDEO_SIZE                (MV2_CFG_CUSTOM_BASE + 77)
