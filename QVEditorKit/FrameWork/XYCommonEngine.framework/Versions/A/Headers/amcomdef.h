...
#define RECTP_WIDTH(rectp) ((rectp)->right-(rectp)->left)
#define RECT_HEIGHT(rect) ((rect).bottom-(rect).top)
#define RECTP_HEIGHT(rectp) ((rectp)->bottom-(rectp)->top)
#define RECT_MIDX(rect) ( (	(rect).right + (rect).left)/2 )
#define RECTP_MIDX(rectp) ( ( (rectp)->right + (rectp)->left )/2 )
#define RECT_MIDY(rect) ( ( (rect).bottom + (rect).top )/2 )
#define RECTP_MIDY(rectp) ( ( (rectp)->bottom + (rectp)->top )/2 )
