...
#define MERR_JNI_BASE					0x10000
#define	MERR_JNI_AMAUD_BASE		(MERR_JNI_BASE + 0x0)
#define	MERR_JNI_AMCAM_BASE		(MERR_JNI_BASE + 0x1000)
#define	MERR_JNI_AMDISP_BASE		(MERR_JNI_BASE + 0x2000)
#define	MERR_JNI_AMTHR_BASE		(MERR_JNI_BASE + 0x3000)
#define	MERR_JNI_AMTMR_BASE		(MERR_JNI_BASE + 0x4000)
#define	MERR_JNI_IMUT_BASE		(MERR_JNI_BASE + 0x5000)
#define	MERR_JNI_JIMUT_BASE		(MERR_JNI_BASE + 0x6000)
#define	MERR_JNI_JAMAUD_BASE		(MERR_JNI_BASE + 0x7000)
#define	MERR_JNI_JAMDISP_BASE		(MERR_JNI_BASE + 0x8000)
#define	MERR_JNI_JBASED_BASE		(MERR_JNI_BASE + 0x9000)
#define	MERR_JNI_JBITMAPUT_BASE		(MERR_JNI_BASE + 0xa000)
#define	MERR_JNI_JHELPER_BASE		(MERR_JNI_BASE + 0xb000)
#define	MERR_JNI_JSTR_BASE		(MERR_JNI_BASE + 0xc000)
#define	MERR_JNI_JSTRAS_BASE		(MERR_JNI_BASE + 0xd000)
#define	MERR_JNI_JMTHR_BASE		(MERR_JNI_BASE + 0xe000)
#define	MERR_JNI_JMTMR_BASE		(MERR_JNI_BASE + 0xf000)
#define	MERR_JNI_JOGL_BASE		(MERR_JNI_BASE + 0x10000)
#define	MERR_JNI_JSECUT_BASE		(MERR_JNI_BASE + 0x11000)
#define	MERR_JNI_JTXT_BASE		(MERR_JNI_BASE + 0x12000)
#define	MERR_JNI_MPM_BASE		(MERR_JNI_BASE + 0x13000)
#define	MERR_JNI_ONLD_BASE		(MERR_JNI_BASE + 0x14000)
#define	MERR_JNI_PLTUT_BASE		(MERR_JNI_BASE + 0x15000)

#define MERR_IOS_BASE					0x30000
#define	MERR_IOS_AMAUD_BASE		(MERR_IOS_BASE + 0x0)
#define	MERR_IOS_AMDISP_BASE		(MERR_IOS_BASE + 0x1000)
#define	MERR_IOS_AMTMR_BASE		(MERR_IOS_BASE + 0x2000)
#define	MERR_IOS_AVFUT_BASE		(MERR_IOS_BASE + 0x3000)
#define	MERR_IOS_IMGUT_BASE		(MERR_IOS_BASE + 0x4000)
#define	MERR_IOS_MPM_BASE		(MERR_IOS_BASE + 0x5000)
#define	MERR_IOS_MTIP_BASE		(MERR_IOS_BASE + 0x6000)
#define	MERR_IOS_FRAME_BASE		(MERR_IOS_BASE + 0x7000)
#define	MERR_IOS_TEXTC_BASE		(MERR_IOS_BASE + 0x8000)
#define	MERR_IOS_TEXTUT_BASE		(MERR_IOS_BASE + 0x9000)
#define	MERR_IOS_UTIL_BASE		(MERR_IOS_BASE + 0xa000)
#define MERR_IOS_MONITOR        (MERR_IOS_BASE + 0xC000) //0x3C000
