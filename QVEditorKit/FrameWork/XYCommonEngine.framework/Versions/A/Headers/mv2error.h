...
#define MVLIB_ERR_MIS_IOS_BASE  (MVLIB_ERR_BASE + 0x25500)
#define	MVLIB_ERR_MOS_BASE		(MVLIB_ERR_BASE + 0x26000)
#define MVLIB_ERR_MOS_IOS_BASE  (MVLIB_ERR_BASE + 0x26500)
#define	MVLIB_ERR_MOSM_BASE		(MVLIB_ERR_BASE + 0x27000)
#define	MVLIB_ERR_PLT_AO_BASE		(MVLIB_ERR_BASE + 0x28000)
#define	MVLIB_ERR_PLAYER_BASE		(MVLIB_ERR_BASE + 0x29000)
#define	MVLIB_ERR_PLAYER_UTIL_BASE		(MVLIB_ERR_BASE + 0x2a000)
#define	MVLIB_ERR_SPLAYER_BASE		(MVLIB_ERR_BASE + 0x2b000)
#define	MVLIB_ERR_V_AO_BASE		(MVLIB_ERR_BASE + 0x2c000)
#define	MVLIB_ERR_PLUGM_BASE		(MVLIB_ERR_BASE + 0x2d000)
#define	MVLIB_ERR_AIFF_BASE		(MVLIB_ERR_BASE + 0x2e000)
#define	MVLIB_ERR_MISM_BASE		(MVLIB_ERR_BASE + 0x2f000)
#define	MVLIB_ERR_PLT_AI_BASE		(MVLIB_ERR_BASE + 0x30000)
#define	MVLIB_ERR_REC_BASE		(MVLIB_ERR_BASE + 0x31000)
#define	MVLIB_ERR_REC_UTIL_BASE		(MVLIB_ERR_BASE + 0x32000)
#define	MVLIB_ERR_STAT_BASE		(MVLIB_ERR_BASE + 0x33000)
#define	MVLIB_ERR_RTMP_PUSH_IOS_BASE		(MVLIB_ERR_BASE + 0x34000)
#define	MVLIB_ERR_RTMP_PUSH_AVA_IOS_BASE		(MVLIB_ERR_BASE + 0x35000)
#define	MVLIB_ERR_RTMP_PUSH_VTB_BASE		(MVLIB_ERR_BASE + 0x36000)
#define	MVLIB_ERR_SSINK_BASE		(MVLIB_ERR_BASE + 0x37000)
#define	MVLIB_ERR_SSRC_BASE		(MVLIB_ERR_BASE + 0x38000)
#define	MVLIB_ERR_HW_VREADER_BASE		(MVLIB_ERR_BASE + 0x39000)
#define	MVLIB_ERR_HW_VREADER_POOL_BASE		(MVLIB_ERR_BASE + 0x3a000)
#define	MVLIB_ERR_HW_VWRITER_DLL_BASE		(MVLIB_ERR_BASE + 0x3b000)
#define	MVLIB_ERR_HW_VWRITER_BASE		(MVLIB_ERR_BASE + 0x3c000)
#define	MVLIB_ERR_SW_VREADER_BASE		(MVLIB_ERR_BASE + 0x3d000)
#define	MVLIB_ERR_SW_VWRITER_BASE		(MVLIB_ERR_BASE + 0x3e000)
#define	MVLIB_ERR_CAMNG_BASE		(MVLIB_ERR_BASE + 0x3f000)
#define	MVLIB_ERR_COMM_KO_LINUX_BASE		(MVLIB_ERR_BASE + 0x40000)
#define	MVLIB_ERR_COMM_AFP_BASE		(MVLIB_ERR_BASE + 0x41000)
#define	MVLIB_ERR_COMM_ALCK_BASE		(MVLIB_ERR_BASE + 0x42000)
#define	MVLIB_ERR_COMM_BM_BASE		(MVLIB_ERR_BASE + 0x43000)
#define	MVLIB_ERR_COMM_HF_BASE		(MVLIB_ERR_BASE + 0x44000)
#define	MVLIB_ERR_COMM_KO_BASE		(MVLIB_ERR_BASE + 0x45000)
#define	MVLIB_ERR_COMM_QB_BASE		(MVLIB_ERR_BASE + 0x46000)
#define	MVLIB_ERR_COMM_RA_BASE		(MVLIB_ERR_BASE + 0x47000)
#define	MVLIB_ERR_COMM_PM_BASE		(MVLIB_ERR_BASE + 0x48000)
