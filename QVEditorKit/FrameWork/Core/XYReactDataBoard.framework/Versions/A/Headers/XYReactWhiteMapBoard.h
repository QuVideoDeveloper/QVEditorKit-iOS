...
#define   RACWB                     [XYReactWhiteMapBoard whiteBoard]
#define   RACWBObserver(key)        [[XYReactWhiteMapBoard whiteBoard] addObserver:self forKey:key]
#define   RACWBRemoveObserver(key)  [[XYReactWhiteMapBoard whiteBoard] removeObserver:self forKey:key]

@interface XYReactWhiteMapBoard : NSObject
...
*  @param key   不允许为空
*/
- (BOOL)isSubscribeForKey:(NSString *_Nonnull)key;
/**
*  数据更新
*
